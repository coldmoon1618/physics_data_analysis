void runISUJetSim(const char *species, int run, int runno, int nevents = 0, const char *simDstFile = "SimDST.root")
{
    ...
    ISUJetTrkClus *myTrkClus = new ISUJetTrkClus("RunSimTrkClus.root",run,species);
