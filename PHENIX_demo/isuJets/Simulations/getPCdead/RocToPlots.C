...
void RocToPlots(bool isData){
  ...
  if(isData)	
  {
    fname  = "/sphenix/user/yzhai/PC_cuts/run13_dat.root";
    max_pc3=1500.0;max_pc1=20000.0;
  }
  else		
  {
    fname  = "/sphenix/user/yzhai/PC_cuts/run13_sim.root";
  ...
  ofstream deadpc3file("run13_deadPC3_new.txt");
  ofstream deadpc1file("run13_deadPC1.txt");
