...
void SingleCandidate(){
    ...
    //////////////////////////////////////////////////
        ...
        if(has_B_ana){
            h_Mbc_2 -> Fill(evt_Mbc);
            h_deE_2 -> Fill(evt_deE);
            h_Mbc_3 -> Fill(evt_Mbc_m);
            h_deE_3 -> Fill(evt_deE_m);
        }
    }//nTotalEvents
...
/*
    ...
    h_deE_2 -> Draw();
    if(makeLog)gPad -> SetLogy();
    if(makeLog) c2 -> SaveAs("candi_Mbc_deE_log.pdf");
    else        c2 -> SaveAs("candi_Mbc_deltaE.pdf");
*/
