...
##########################################################################
# Basic setups
input_file_list = ['/home/belle2/zhai/B0_phi_KS0/B02phiKS0MC/100_2k_evts/0/signalevents_2000.mdst.root']
output_file = 'MC13a_sigEvt.root'
max_event = 0
...
# B0 -> phi K_S0 reco
ma.reconstructDecay('B0:reco -> phi:reco K_S0:merged', '', path=path)
