...
/*
Both BB and all bkg component plots
...
void DrawStacked() {
    ...
    B0_cand -> AddFile("uubar.root");
    B0_cand -> AddFile("ddbar.root");
    B0_cand -> AddFile("ssbar.root");
    B0_cand -> AddFile("ccbar.root");
    ...
    TH1F *h4_Mbc = new TH1F("h4_Mbc",   "Continuum",    50,5.25, 5.3);
    TH1F *h3_Mbc = new TH1F("h3_Mbc",   "B+B- bkg",     50,5.25, 5.3);
    TH1F *h2_Mbc = new TH1F("h2_Mbc",   "B0B0bar bkg",  50,5.25, 5.3);
    TH1F *h1_Mbc = new TH1F("h1_Mbc",   "signal evts",  50,5.25, 5.3);
    
    TH1F *h4_deE = new TH1F("h4_deE",   "Continuum",    40, -.2,  .2);
    TH1F *h3_deE = new TH1F("h3_deE",   "B+B- bkg",     40, -.2,  .2);
    TH1F *h2_deE = new TH1F("h2_deE",   "B0B0bar bkg",  40, -.2,  .2);
    TH1F *h1_deE = new TH1F("h1_deE",   "signal evts",  40, -.2,  .2);

    TH1F *h4_mKK = new TH1F("h4_mKK",   "Continuum",    50,  1.,1.05);
    TH1F *h3_mKK = new TH1F("h3_mKK",   "B+B- bkg",     50,  1.,1.05);
    TH1F *h2_mKK = new TH1F("h2_mKK",   "B0B0bar bkg",  50,  1.,1.05);
    TH1F *h1_mKK = new TH1F("h1_mKK",   "signal evts",  50,  1.,1.05);
    ...
    c1 -> SaveAs("all_comp_rangeCut.pdf");
    ...
    c2 -> SaveAs("BB_comp_rangeCut.pdf");
