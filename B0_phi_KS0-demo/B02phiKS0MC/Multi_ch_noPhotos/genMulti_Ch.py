...
generator = path.add_module("EvtGenInput", userDECFile='/home/belle2/zhai/B0_phi_KS0/B02phiKS0MC/Multi_ch_noPhotos.dec')
...
add_mdst_output(path, filename='multi_ch_events_2000.mdst.root')
