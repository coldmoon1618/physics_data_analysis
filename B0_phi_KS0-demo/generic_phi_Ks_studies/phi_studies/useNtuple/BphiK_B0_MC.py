input_files_list = []
output_file = 'MCBphiK_B0_MC.root' 
...
fillParticleListFromMC('B0:generator', '', writeOut = True, path=path) 

ma.variablesToNtuple('B0:generator', 
        ['useCMSFrame(p)','useCMSFrame(E)','useCMSFrame(phi)','useCMSFrame(theta)',
        'mcPDG','mcDaughter(0,PDG)','mcDaughter(1,PDG)','mcDaughter(2,PDG)',
