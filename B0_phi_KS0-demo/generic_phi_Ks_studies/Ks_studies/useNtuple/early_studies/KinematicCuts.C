...
//////////////////////////// RECO ///////////////////////////////////////////////
//fitting & bkgSub
    TH1F *h_p_sband         = new TH1F("h_p_sband","",              60,0.,2*maxM);
    TH1F *h_p_bgsub         = new TH1F("h_p_bgsub","",              60,0.,2*maxM);
    TH1F *h_pi_p_sband      = new TH1F("h_pi_p_sband","",           92,0.,2*maxM);
    TH1F *h_pi_p_bgsub      = new TH1F("h_pi_p_bgsub","",           92,0.,2*maxM);
    ...
    TH1F *h_pstar_sband         = new TH1F("h_pstar_sband","",          60,0.,2*maxM);
    TH1F *h_pstar_bgsub         = new TH1F("h_pstar_bgsub","",          60,0.,2*maxM);
    TH1F *h_pi_pstar_sband      = new TH1F("h_pi_pstar_sband","",       92,0.,2*maxM);
    TH1F *h_pi_pstar_bgsub      = new TH1F("h_pi_pstar_bgsub","",       92,0.,2*maxM);
    TH1F *h_pi_phistar_sband    = new TH1F("h_pi_phistar_sband","",     40,-pi,pi);
    TH1F *h_pi_phistar_bgsub    = new TH1F("h_pi_phistar_bgsub","",     40,-pi,pi);
    TH1F *h_pi_thetastar_sband  = new TH1F("h_pi_thetastar_sband","",   40,0.,pi);
    TH1F *h_pi_thetastar_bgsub  = new TH1F("h_pi_thetastar_bgsub","",   40,0.,pi);
//////////////////////// MC true ////////////////////////////////////////////////
    TH1F *h_p_gen           = new TH1F("h_p_gen","p(KS0)",              60,0.,2*maxM);
    TH1F *h_pi_p_gen        = new TH1F("h_pi_p_gen","p(pi)",            92,0,2*maxM);
    TH1F *h_pi_phi_gen      = new TH1F("h_pi_phi_gen","#phi(pi)",       40,-pi,pi);
    TH1F *h_pi_theta_gen    = new TH1F("h_pi_theta_gen","#theta(pi)",   40,0,pi);

    TH1F *h_pstar_gen       = new TH1F("h_pstar_gen","p*(K_S0)",        60,0.,2*maxM);
    TH1F *h_pi_pstar_gen    = new TH1F("h_pi_pstar_gen","p*(pi)",        92,0,2*maxM);
    TH1F *h_pi_phistar_gen      = new TH1F("h_pi_phistar_gen","#phi*(pi)",       40,-pi,pi);
    TH1F *h_pi_thetastar_gen    = new TH1F("h_pi_thetastar_gen","#theta*(pi)",   40,0,pi);
//////////////////////////////////////////////////////////
...
//////////////////////////// RECO ///////////////////////////////////////////////
    for(int i=0; i<KEntries; i++)
    {
        ...
        if(bkgSub){
            ...
            {//side bands
                ...
                h_pi_thetastar_sband -> Fill(thetastar0);
                h_pi_thetastar_sband -> Fill(thetastar1);
            ...
            {//3 sigmas
                ...
                h_pi_thetastar_bgsub -> Fill(thetastar0);
                h_pi_thetastar_bgsub -> Fill(thetastar1);
    ...
    for(int i=0; i<KgenEntries; i++){
        ...
        if((dau0==211&&dau1==-211)||(dau0==-211&&dau1==211)){
            ...
            h_pi_thetastar_gen      ->Fill(gen_thetastar0);
            h_pi_thetastar_gen      ->Fill(gen_thetastar1);
...
/////////////////////// PLOTS //////////////////////////////////////////////////
    if(bkgSub){
        ...
        //Background subtraction results plot
        gStyle->SetOptStat(0);
