...
void matchEff() {
    ...
    //TH1F *h_pstar_gen   = new TH1F("h_pstar_gen","CMSFrame p(KS0:gen)",60,0.,3);
    //TH1F *h_pstar_mat   = new TH1F("h_pstar_mat","CMSFrame p(KS0:mat)",60,0.,3);
...
*Br    3 :__candidate__ : __candidate__/I                                    *
*Br    4 :__ncandidates__ : __ncandidates__/I                                *
*Br    5 :__weight__ : __weight__/D                                          *
*Br    6 :InvM      : InvM/D                                                 *
*Br    7 :M         : M/D                                                    *
*Br    8 :p         : p/D                                                    *
*Br    9 :E         : E/D                                                    *
*Br   10 :useCMSFrame__bophi__bc : useCMSFrame__bophi__bc/D                  *
*Br   11 :useCMSFrame__botheta__bc : useCMSFrame__botheta__bc/D              *
*Br   12 :useCMSFrame__bop__bc : useCMSFrame__bop__bc/D                      *
*Br   13 :mcMother__boPDG__bc : mcMother__boPDG__bc/D                        *
*Br   14 :mcPDG     : mcPDG/D                                                *
*Br   15 :mcDaughter__bo0__cmPDG__bc : mcDaughter__bo0__cmPDG__bc/D          *
*Br   16 :mcDaughter__bo1__cmPDG__bc : mcDaughter__bo1__cmPDG__bc/D          *
*Br   17 :mcDaughter__bo2__cmPDG__bc : mcDaughter__bo2__cmPDG__bc/D          *
*Br   18 :mcFlightDistance : mcFlightDistance/D                              *
*Br   19 :mcDistance : mcDistance/D                                          *
*/
    ...
    //auto rp = new TRatioPlot(h_pstar_gen,h_pstar_mat);
