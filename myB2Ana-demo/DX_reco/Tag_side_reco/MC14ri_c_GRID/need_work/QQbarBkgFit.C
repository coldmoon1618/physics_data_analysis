...
/* 35 */"#Lambda_{c}^{-}p#pi^{+}",
    ...
    Form("[%02d]   %s   SigProb>%.3f %s CombinedFit",myMode,fState[myMode],minProb,matchStr[looseMatched])));
    ...
    */
    ...
    Form("[%02d]   %s   SigProb>%.3f %s CombinedPull",myMode,fState[myMode],minProb,matchStr[looseMatched])));
