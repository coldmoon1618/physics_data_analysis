...
void MixedBkgFit(  
    ...
    cutString+=Form("isMixed>.5&&decMode==1.0*%d&&SigProb>%.3f",myMode,minProb);
    /*
    if(looseMatched){
    ...
    */
    RooDataSet Mbc_data("Mbc_data","", RooArgSet(isMixed, Mbc, SigProb, decMode, isSignal, isSigAccMiss, isSigAccMissGamma, isSigAccWrongFSP), ImportFromFile(fInName,"B_cand"), Cut(cutString)); 
